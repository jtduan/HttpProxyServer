...
public class ComputerSide {
    private final static Logger log = LoggerFactory.getLogger(ComputerSide.class);

    public static List<Socket> computerSockets = new ArrayList<>();
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    computerSockets.add(connectedSocket);
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
